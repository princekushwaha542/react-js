...
const RightCard = () => {
  return (
    <div className='h-full w-80 rounded-4xl overflow-hidden relative'>
      <img className='h-full w-full object-cover' src="https://plus.unsplash.com/premium_photo-1749010150570-366f704b7c96?q=80&w=1936&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="RightCardIMG" />
        ...
        <div>
            <p className='text-white mb-10 text-lg'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Blanditiis 
                ...
                <div className='flex justify-between items-center'>
                 <button className=' bg-blue-600 text-white font-medium py-2 px-8 rounded-full'>Satisfied</button>
