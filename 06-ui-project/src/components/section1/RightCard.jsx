...
const RightCard = (props) => {
  return (
    <div className='h-full w-80 rounded-4xl shrink-0 mr-4 overflow-hidden relative'>
      ...
      p-8'>
        <h2 className='h-10 w-10 rounded-full flex items-center justify-center bg-white drop-shadow-lg'>{props.sno}</h2>
        <div>
            <p className='text-white mb-10 text-shadow-9xs text-lg'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Blanditiis 
                ...
                <div className='flex justify-between items-center'>
                 ...
                 <button style={{backgroundColor:props.color}} className='  text-white font-medium py-2 px-3 rounded-full'> <ArrowRight /></button>
                </div>
        </div>
      </div>
    </div>
